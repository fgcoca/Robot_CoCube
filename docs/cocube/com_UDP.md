...
![Materiales](../img/CoCube/mat06.png){.center-img}
...
![Bloque al empezar](../img/CoCube/comunicacionesUDP1.png){.center-img}

En caso de no configurar WiFi correctamente aparecerá en el IDE el siguiente mensaje:

![Mensaje error WiFi](../img/CoCube/error_wifi.png){.center-img} 
...
![Bloque cuando botón A](../img/CoCube/comunicacionesUDP2.png){.center-img}
...
![Bloque cuando BUFFER = CUADRO](../img/CoCube/comunicacionesUDP3.png){.center-img}
...
![Bloque cuando botón B](../img/CoCube/comunicacionesUDP4.png){.center-img}
...
![Bloque cuando BUFFER = BORRA](../img/CoCube/comunicacionesUDP5.png){.center-img}
...
![Bloque cuando envia paquete UDP...](../img/CoCube/comunicacionesUDP6.png){.center-img}
...
![Programa comunicaciones UDP](../img/CoCube/comunicacionesUDP.png){.center-img}
...
![Programa comunicaciones UDP](../img/CoCube/comunicacionesUDP.gif){.center-img}
