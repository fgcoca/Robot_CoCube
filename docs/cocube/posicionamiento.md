...
![Materiales](../img/CoCube/mat03.png){.center-img}
...
![Maze Challenge](../img/CoCube/Maze_Challenge.png){.center-img}
...
![Bloque di__ en MicroBlocks](../img/CoCube/di.png){.center-img}
...
![Bloque di__ en MicroBlocks](../img/CoCube/di1.png){.center-img}
...
![Bloque di__ en MicroBlocks](../img/CoCube/di2.png){.center-img}
...
![CoCube mostrando su posición](../img/CoCube/di_posicion.gif){.center-img}
...
![CoCube mostrando su posición de forma gráfica y textual](../img/CoCube/di_posicion_grafica.gif){.center-img}
...
![CoCube fuera de CoMap](../img/CoCube/mov_ABCDE_out.png){.center-img}
