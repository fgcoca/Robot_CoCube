...
![Movimientos básicos](../img/CoCube/mov_base.gif){.center-img}
...
![Frenar y detener](../img/CoCube/freno_paro.gif){.center-img}
...
![Movimiento circular](../img/CoCube/Movimiento_circular.gif){.center-img}
...
![Trayectoria cuadrada](../img/CoCube/Trayectoria_cuadrada.gif){.center-img}
