...
![Materiales](../img/CoCube/mat010.png){.center-img}
...
![Línea](../img/CoCube/id4_res.png){.center-img40}
...
![Configuración de parámetros](../img/CoCube/id4_param.png){.center-img75}
...
![Devolución de resultados](../img/CoCube/id4_resul.png){.center-img}
...
![Devolución de resultados](../img/CoCube/id4_resul_color_lin.png){.center-img75}
...
![Bloque Establecer modo de Sentry2](../img/CoCube/B_est_modo_sentry2_line.png){.center-img40}
...
![Bloque resultados de las pruebas de Sentry2](../img/CoCube/B_res_pruebas_sentry2.png){.center-img40}  
...
![Bloque detección de atributos del objeto línea](../img/CoCube/B_sentry2_line_detec.png){.center-img40}
...
![Configuración de linea para el siguelineas](../img/CoCube/conf_line_sigue.png){.center-img40}
...
![Bloque Sentry2 detect mode](../img/CoCube/B_sentry2_detect_mode.png){.center-img40}

Cuando "Sentry2 detect mode" es 1, se presentan por pantalla los 5 atributos de la detección de línea.

![Información de los parámetros de detección de línea](../img/CoCube/Sentry2_detect_mode_param.png){.center-img}
...
![Instante de detección de línea](../img/CoCube/Sentry2_detect_line_instant.png){.center-img}
...
![Control diferencial de las ruedas](../img/CoCube/Sentry2_control_dif.png){.center-img} 
...
![Frenado de la ruedas](../img/CoCube/Sentry2_freno.png){.center-img75}

El código completo lo vemos en la imagen siguiente y bajo la misma está el enlace de descarga del mismo.

![Programación de CoCube siguelineas](../img/CoCube/P_ejem_siguelineas.png){.center-img}
