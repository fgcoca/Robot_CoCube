...
![Teclado y CoCube conectados con PC](../img/CoCube/conex_TB.png){.center-img}

**2.** **Activar o desactivar BLE**: si es necesario activa la opción de la imagen siguiente.

![Activar o desactivar BLE](../img/CoCube/act_des_BLE.png){.center-img}
...
![Teclado online](../img/CoCube/teclado_online.png){.center-img}
...
![Eventos de teclado](../img/CoCube/eventos_teclado.png){.center-img}
...
![Eventos de teclado](../img/CoCube/eventos_teclado.gif){.center-img}
...
![Abrir ejemplo de control por teclado](../img/CoCube/ejemplo_teclado.png){.center-img}
...
![Ejemplo de control por teclado personalizado](../img/CoCube/ejemplo_teclado_pers.png){.center-img}
...
![Ejemplo de control por teclado personalizado](../img/CoCube/ejemplo_teclado_pers.gif){.center-img}
...
![Recogedor de objetos](../img/CoCube/Recogedor_objetos.png){.center-img}
